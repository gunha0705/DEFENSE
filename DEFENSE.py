...
def title():
    ...
    screen.fill(Title_color)
    drawText("DEFENSE",50,BLUE,pad_width/2,pad_height/4)
    ...
    title_music = pygame.mixer.Sound('DEFENSE/타이틀.wav')
    title_music.play(-1)
    pygame.display.flip()
    pressAnykey()
...
def runGame():
    ...
    title_music.stop()
    background_music = pygame.mixer.Sound('DEFENSE/배경음악.wav')
...
def initGame():
    ...
    hero1 = pygame.image.load('DEFENSE/원2.png')
    background = pygame.image.load('DEFENSE/격자.png')
    enemys.append(pygame.image.load('DEFENSE/적.png'))
    
    bullet = pygame.image.load('DEFENSE/총알.png')
    boom = pygame.image.load('DEFENSE/폭발.png')
    boom = pygame.transform.scale(boom,(65,65))
    
    shot_sound = pygame.mixer.Sound('DEFENSE/shot.wav')
